...
class DTEControlCounter(models.Model):
    ...
    establishment_code = models.CharField(max_length=4, default="X001")
    pos_code = models.CharField(max_length=4, default="X001")
...
class DTEBranchConfig(models.Model):
    ...
    cod_estable_mh = models.CharField(max_length=10, blank=True, default="X001")
    cod_estable = models.CharField(max_length=10, blank=True, default="X001")
    cod_punto_venta_mh = models.CharField(max_length=10, blank=True, default="X001")
    cod_punto_venta = models.CharField(max_length=10, blank=True, default="X001")
