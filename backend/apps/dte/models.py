...
class DTEControlCounter(models.Model):
    ...
    establishment_code = models.CharField(max_length=4, default="S001")
...
class DTEBranchConfig(models.Model):
    ...
    cod_estable_mh = models.CharField(max_length=10, blank=True, default="S001")
    cod_estable = models.CharField(max_length=10, blank=True, default="S001")
