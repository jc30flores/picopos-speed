                ...
                migrations.RunSQL(
                    ...
                    BEGIN
                        ...
                        IF NOT EXISTS (
                            ...
                            FROM information_schema.columns
                            WHERE table_name = 'orders_order'
                              AND column_name = 'whatsapp_num_cliente_country'
                        ) THEN
                            ALTER TABLE orders_order
                                ADD COLUMN whatsapp_num_cliente_country varchar(8) NOT NULL DEFAULT '';
                        END IF;
                        ...
                        ALTER TABLE orders_order
                            ALTER COLUMN whatsapp_num_cliente_country SET DEFAULT '';

                        ALTER TABLE orders_order
                            ALTER COLUMN whatsapp_num_cliente SET NOT NULL;

                        ALTER TABLE orders_order
                            ALTER COLUMN whatsapp_num_cliente_country SET NOT NULL;
                    END
                    $$;
                    """,
                    reverse_sql="""
                    ALTER TABLE orders_order
                        DROP COLUMN IF EXISTS whatsapp_num_cliente_country;
