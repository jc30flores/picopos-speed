...
class RolePathAccessMiddlewareTests(TestCase):
    ...
    def test_worker_cannot_read_feature_settings(self):
        self._login_worker()
    ...
    def test_manager_is_blocked_from_reportes_and_caja_history_endpoints(self):
        ...
        sales = self.client.get("/api/reports/sales/?date_from=2026-01-01&date_to=2026-01-01")
        ...
        cash_session = self.client.get("/api/cashier/sessions/1/")
        self.assertEqual(cash_session.status_code, 403)
