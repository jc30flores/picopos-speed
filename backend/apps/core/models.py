...
class DTEGlobalSettings(models.Model):
    ...
    fiscal_email_enabled = models.BooleanField(default=False)
    fiscal_whatsapp_enabled = models.BooleanField(default=False)
    fiscal_pdf_enabled = models.BooleanField(default=False)
    fiscal_json_enabled = models.BooleanField(default=False)
