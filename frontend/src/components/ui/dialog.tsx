...
>(({ className, children, showCloseButton = true, ...props }, ref) => {
  const contentProps = { "aria-describedby": undefined, ...props };
  return (
    <DialogPortal>
      <DialogOverlay />
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col-reverse gap-2 sm:flex-row sm:flex-wrap sm:justify-end sm:space-x-0 [&>*]:w-full sm:[&>*]:w-auto", className)} {...props} />
);
